...
def load_optimized_adaptive_model(model_name, baseline_model, device, debug=True, quiet=False, optimization_level=None):
    ...
    if "gpt" in model_name.lower():
        from sentinel.models.loaders.gpt2_loader_optimized import load_optimized_adaptive_model_gpt
        ...
        from sentinel.models.loaders.loader import load_adaptive_model
