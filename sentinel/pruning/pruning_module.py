...
This is the original JAX-based pruning module, maintained for backward compatibility.
For new code, consider using the fixed_pruning_module or fixed_pruning_module_jax instead.
"""
