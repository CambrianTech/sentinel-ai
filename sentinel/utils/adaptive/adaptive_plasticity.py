...
from sentinel.utils.pruning.strategies import get_strategy as get_pruning_strategy
from sentinel.utils.pruning.growth import (
    grow_attention_heads_gradually, 
    determine_active_heads,
    get_strategy as get_growth_strategy
)
from sentinel.utils.pruning.head_lr_manager import HeadLRManager
from sentinel.utils.train_utils import FineTuner
from sentinel.utils.metrics_logger import MetricsLogger

# Import degeneration detection and display tools
from sentinel.utils.pruning.inference_utils import (
...
class AdaptivePlasticitySystem:
    ...
    def display_model_comparison(self, prompts=None, num_prompts=3):
        ...
        if prompts is None:
            from sentinel.utils.pruning.inference_utils import get_test_prompts
