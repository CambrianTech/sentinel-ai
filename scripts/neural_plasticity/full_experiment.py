...
"""
Neural Plasticity Full Experiment Runner

This script runs a comprehensive neural plasticity experiment with real models and datasets,
using the neural plasticity module for dynamic pruning, fine-tuning, and visualization.
...
- Creates comprehensive HTML dashboards showing the entire process
...
Usage:
    ...
    python scripts/neural_plasticity/full_experiment.py --model_name gpt2 --dataset gutenberg
"""
...
def main():
    ...
    try:
        ...
        if output_dir:
            ...
            print(f"!python run_neural_plasticity/full_experiment.py --device cuda")
